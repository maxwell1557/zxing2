...
public class ZxingConfig implements Serializable {
    ...
    /*扫描框颜色*/
    @ColorRes
    private int frameLineColor = R.color.frameLineColor;
    ...
    public void setScanDescText(String scanDescText) {
        this.scanDescText = scanDescText;
    }
}
